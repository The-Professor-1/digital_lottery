...
# Made production-safe: some bingo indexes/columns may already match or never existed.
...
class Migration(migrations.Migration):
    ...
    operations = [
        # Index may already use Django's auto name (or never existed on this DB).
        # Only update migration state — do not rename on the database.
            ...
            database_operations=[
                migrations.RunSQL(
                    sql=(
                        ...
                        "ADD COLUMN IF NOT EXISTS transaction_reference "
                        "varchar(128) NULL;"
                    ),
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                default=20,
                help_text='Seconds for card selection window',
            ),
        ),
        migrations.AlterField(
            model_name='gamesettings',
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                default=100,
                help_text='Total number of cards available',
            ),
        ),
        migrations.AlterField(
            ...
            state_operations=[
                migrations.AddIndex(
                    ...
                    index=models.Index(
                        ...
                        name='deposit_req_transac_48b05b_idx',
                    ),
                ),
            ],
            database_operations=[
                migrations.RunSQL(
                    sql=(
                        "CREATE INDEX IF NOT EXISTS deposit_req_transac_48b05b_idx "
