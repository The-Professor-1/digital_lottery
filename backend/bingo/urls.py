...
urlpatterns = [
    ...
    path('admin-dashboard/lottery-set-manual-winners/', lottery_views.lottery_set_manual_winners, name='lottery-set-manual-winners'),
    path('admin-dashboard/lottery-hold-ticket/', lottery_views.lottery_admin_hold_ticket, name='lottery-hold-ticket'),
    ...
    path('api/admin-dashboard/lottery-set-manual-winners/', lottery_views.lottery_set_manual_winners, name='lottery-set-manual-winners-api'),
    path('api/admin-dashboard/lottery-hold-ticket/', lottery_views.lottery_admin_hold_ticket, name='lottery-hold-ticket-api'),
